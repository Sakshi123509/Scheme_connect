...
import { authAPI } from "../services/api"; // ✅ authAPI import
import bgImage from "../assets/images/bg.jpg"; // ✅ proper import
...
export default function Login() {
  ...
  const handleLogin = async () => {
    try {
      const res = await authAPI.login(formData); // ✅ authAPI use karo
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url(${bgImage})` }} // ✅ imported variable
    >
      <div className="w-[780px] h-[450px] bg-white rounded-xl shadow-2xl flex overflow-hidden">
        <div
          className="w-1/2 bg-cover object-cover"
          style={{ backgroundImage: `url(${loginImage})` }} // ✅ imported variable
        ></div>

        <div className="w-1/2 p-10 flex flex-col justify-center">
          <div>
            <img
              src={logoImage} // ✅ imported variable
              alt="Logo"
